...
from .facelattice import FlatticeCNN
from .facelattice import FlatticeFFNN
...
class CubeLattice:
    ...
    def to_FlatticeFFNN(self): #shape height x weight
        return FlatticeFFNN(self.lattice, self.vertices, self.dim, self.M, self.b)
    ...
    def to_FlatticeCNN(self): #shape height x weight
        ...
        return FlatticeCNN(self.lattice, self.vertices, self.vertices, self.dim)
